odoo.define('web_mrp_gantt_view.GanttView', function (require) {
    "use strict";

    var AbstractView = require('web.AbstractView');
    var GanttModel = require('web_mrp_gantt_view.GanttModel');
    var GanttRenderer = require('web_mrp_gantt_view.GanttRenderer');
    var GanttController = require('web_mrp_gantt_view.GanttController');
    ...
    var GanttView = AbstractView.extend({
        ...
        viewType: 'ganttview',
        cssLibs: [
            "/web_mrp_gantt_view/static/lib/dhtmlxGantt/sources/dhtmlxgantt.css"
        ],
        jsLibs: [
            "/web_mrp_gantt_view/static/lib/dhtmlxGantt/sources/dhtmlxgantt.js",
            "/web_mrp_gantt_view/static/lib/dhtmlxGantt/sources/api.js",
        ],
