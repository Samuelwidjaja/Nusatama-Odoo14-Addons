        ...
        for obj_line in self:
            ...
            if obj_line.committed_analytic_line_ids and obj_line.analytic_account_id:
                ...
                if obj_line.move_id.state == 'draft':
                    ...
                    obj_line.committed_analytic_line_ids.filtered(lambda al: al.product_id == obj_line.product_id).unit_amount = obj_line.committed_analytic_line_ids.filtered(lambda al: al.product_id == obj_line.product_id).unit_amount - obj_line.quantity if obj_line.move_id.move_type in ('in_invoice', 'out_refund') else -obj_line.quantity
