        ...
        for obj_line in self:
            ...
            if obj_line.committed_analytic_line_ids and obj_line.analytic_account_id:
                ...
                if obj_line.move_id.state == 'draft':
                    ...
                    print ('==committed_analytic_line_ids==',obj_line.committed_analytic_line_ids,obj_line.product_id,obj_line.committed_analytic_line_ids.mapped('product_id'),obj_line.committed_analytic_line_ids.filtered(lambda al: al.product_id.id == obj_line.product_id.id))
